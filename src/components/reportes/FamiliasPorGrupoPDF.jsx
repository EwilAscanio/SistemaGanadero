        ...
        <Page size="A4" orientation="landscape" style={styles.page} key={`page-${pageIndex}`}>
          ...
          {pageIndex === 0 && (
            <>
              ...
              <Text style={styles.title}>Reporte de Familias por Grupo</Text>
              <Text style={styles.subtitle}>
                Grupo: {grupo} {familia !== "Todos" ? `| Familia: ${familia}` : ""} | Total animales: {totalAnimales}
              </Text>
            </>
          )}
...
export default FamiliasPorGrupoPDF;