    ...
    debounceTimeoutRef.current = setTimeout(async () => {
      try {
        ...
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/api/produccionleche?search=${codigo}` // <--- CAMBIA ESTA RUTA Y QUERY
        );
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      ...
      if (res.status === 200) {
        Swal.fire({
          title: "Éxito",
          text: "La produccion de Leche se registró correctamente.",
          icon: "success",
          confirmButtonColor: "#3085d6",
        });
      ...
      Swal.fire({
        title: "Error",
        text: "Ocurrió un error al registrar el proceso de registro.",
        icon: "error",
        confirmButtonColor: "#d33",
      });
    }
             ...
             <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-3 pr-4 py-2 border ${
                    errors.litros_lec ? "border-red-500" : "border-gray-300" // Añadir manejo de error si es necesario validación para este campo
                  } rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  {...register("litros_lec", {
